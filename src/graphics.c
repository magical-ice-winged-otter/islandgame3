...
const u16 gTitleScreenBgPalettes[]         = INCBIN_U16("graphics/title_screen/pokemon_logo.gbapal",
                                                        "graphics/title_screen/wingsofchaos_tiles.gbapal");
...
const u32 gTitleScreenEmeraldVersionGfx[]  = INCBIN_U32("graphics/title_screen/wingsofchaos_version.8bpp.smol");
const u16 gTitleScreenPressStartPal[]      = INCBIN_U16("graphics/title_screen/press_start_islandgame.gbapal");
const u32 gTitleScreenPressStartGfx[]      = INCBIN_U32("graphics/title_screen/press_start_islandgame.4bpp.smol");
