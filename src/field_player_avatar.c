...
static const u16 sPlayerAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_OLIVIA_SURFING,     OBJ_EVENT_GFX_OLIVIA_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_MAY_UNDERWATER},
...
static const u16 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        ...
        {OBJ_EVENT_GFX_OLIVER_SURFING,     PLAYER_AVATAR_FLAG_SURFING},
...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
     ...
     && IsRunningDisallowed(gObjectEvents[gPlayerAvatar.objectEventId].currentMetatileBehavior) == 0 && !FollowerNPCComingThroughDoor())
    {
        ...
        {
            if ((heldKeys & B_BUTTON) && gSaveBlock1Ptr->autoRun)
