...
u8 FldEff_TalkingIcon(void)
{
    ...
    if (spriteId != MAX_SPRITES)
    {
        ...
        UpdateSpritePaletteByTemplate(&sSpriteTemplate_TalkingIcon, &gSprites[spriteId]);
    }
...
u8 FldEff_ThinkingIcon(void)
{
    ...
    if (spriteId != MAX_SPRITES)
    {
        ...
        UpdateSpritePaletteByTemplate(&sSpriteTemplate_ThinkingIcon, &gSprites[spriteId]);
    }
