...
const u16 gMetatiles_islandgame_lumine_aetheria_secondary[] = INCBIN_U16("data/tilesets/secondary/islandgame_lumine_aetheria_secondary/metatiles.bin");
const u16 gMetatileAttributes_islandgame_lumine_aetheria_secondary[] = INCBIN_U16("data/tilesets/secondary/islandgame_lumine_aetheria_secondary/metatile_attributes.bin");
