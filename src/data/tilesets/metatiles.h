...
const u16 gMetatiles_islandgame_ssrain_general[] = INCBIN_U16("data/tilesets/primary/islandgame_ssrain_general/metatiles.bin");
const u16 gMetatileAttributes_islandgame_ssrain_general[] = INCBIN_U16("data/tilesets/primary/islandgame_ssrain_general/metatile_attributes.bin");
