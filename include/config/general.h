...
#if ISLANDGAME_DEBUG == FALSE
// NOTE: the above condition doesn't and I don't know why. 
// If you see this and you are wondering why nothing is printing, you have to comment out the below line.
// #define NDEBUG
#endif
