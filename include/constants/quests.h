...
#define SUB_QUEST_AETHERIA_MELISSA_1       51
#define SUB_QUEST_AETHERIA_MELISSA_2       52
#define SUB_QUEST_AETHERIA_MELISSA_3       53
#define SUB_QUEST_COUNT_AETHERIA_MELISSA   3

#define SUB_QUEST_COUNT (SUB_QUEST_COUNT_POKEDEX_MILESTONE + SUB_QUEST_COUNT_PERSI_BERRY + SUB_QUEST_COUNT_GYM_CHALLENGE + SUB_QUEST_COUNT_COUCH_POTATO + SUB_QUEST_COUNT_CUBONE + SUB_QUEST_COUNT_ARNIE + SUB_QUEST_COUNT_AETHERIA_MELISSA)
